...
subtitle: "A short instruction in how to use Markdown for scientific writing"
author:
...
```{r, echo=FALSE, fig.cap="... and renders to this.", fig.margin = TRUE}
knitr::include_graphics("figures/headers.png")
```
``` markdown
# Heading 
## Heading 
...
# Tips
![Optional outline view that enables quick navigation across larger documents](figures/fold_out.png)
