...
To check the result of our python code, we import it as raster and plot it with the [`rasterVis`](https://oscarperpinan.github.io/rastervis/) package. `rasterVis` allows to use the ggplot syntax to plot raster objects.
